...
@SystemMessage("""
            ...
            """)
public interface JavaDocAssistant {
    ...
    @UserMessage("""
            ...
            """)
    public SourceWithJavaDoc suggestTest(String programmingLanguage, String product, String version, String extraContext, String source);
